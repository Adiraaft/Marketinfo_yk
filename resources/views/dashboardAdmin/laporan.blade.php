...
@section('content')
    <div class="mt-7 px-15">
        <h3 class="font-bold text-2xl text-secondary">Laporan Harga Komoditas
            <span>
                {{ $markets->name_market }}
            </span>
        </h3>
    ...
    <script>
        document.getElementById('kategori').addEventListener('change', function() {
            ...
            const url = "{{ url('admin/laporan/by-category') }}/" + categoryId;
    ...
    <script>
        document.getElementById('btnShow').addEventListener('click', function() {
            ...
            // =====================================
            // PASAR AMBIL DARI USER LOGIN
            // =====================================
            const market = "{{ auth()->user()->market_id }}"; // ← FIX DI SINI
            ...
            document.getElementById("btnExportExcel").href =
                `{{ url('admin/laporan/export/excel') }}?${params.toString()}`;
            ...
            // URL Filter
            const url =
                `{{ url('admin/laporan/filter') }}?${params.toString()}`;
