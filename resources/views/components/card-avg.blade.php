<div class="md:flex grid pb-4 min-w-full border border-gray-300 h-auto rounded-2xl">
    ...
    <div class="md:mt-4 md:mr-4 md:pl-0 pl-4 flex-1">
        ...
        {{-- Chart --}}
        <div id="chart-{{ $item->id_commodity }}{{ !empty($item->market_name) ? '-market' : '' }}"
            class="mt-4 w-full h-16" data-chart='@json($item->chart_prices ?? [])' data-trend="{{ request('trend') }}">
        </div>
