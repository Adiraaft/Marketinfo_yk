    ...
    <div class="space-y-3">
        ...
        <div>
            <a href="{{ route('superadmin.setting') }}"
                class="flex gap-2 py-3 px-7 rounded-lg transition-all {{ request()->routeIs('superadmin.setting') ? 'bg-white text-secondary' : 'text-white hover:text-secondary hover:bg-white' }}">
